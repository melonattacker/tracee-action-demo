...
Please review the Tracee [documentation](https://aquasecurity.github.io/tracee) to understand the signatures, and review the details of each trigger on the json below:
